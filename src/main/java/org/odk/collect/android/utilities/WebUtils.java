...
/**
 * Common utility methods for managing the credentials associated with the request context and constructing http
 * context, client and request with the proper parameters and OpenRosa headers.
 * 
...
public final class WebUtils {
    ...
    /**
     * Remove all credentials for accessing the specified host and, if the username is not null or blank then add a
     * (username, password) credential for accessing this host.
     * 
     * @param username
     * @param password
     * @param host
    ...
    public static final void setGoogleHeaders(HttpRequest req) {
        ...
        String protocol = settings
                .getString(PreferencesActivity.KEY_PROTOCOL, PreferencesActivity.PROTOCOL_ODK_DEFAULT);
    ...
    /**
     * Create an httpClient with connection timeouts and other parameters set. Save and reuse the connection manager
     * across invocations (this is what requires synchronized access).
     * 
     * @param timeout
    ...
    /**
     * Common method for returning a parsed xml document given a url and the http context and client objects involved in
     * the web connection.
     * 
     * @param urlString
     * @param localContext
    ...
    // get form reference
    public static String readBytesFromStream(HttpResponse response) {
