...
public class DataManagerList extends ListActivity implements DeleteInstancesListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mToggleButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mSelected.size() == getListView().getAdapter().getCount()) {
                    checkAll = false;
                    mSelected.clear();
        ...
        ArrayList<InstanceProviderClass> list = getAllData();
        // render total instance view
        TwoItemChoiceAdapter adapter = new TwoItemChoiceAdapter(DataManagerList.this, R.layout.data_manage_list, list);
    ...
    protected void onResume() {
        ...
        if (mDeleteInstancesTask != null && mDeleteInstancesTask.getStatus() == AsyncTask.Status.FINISHED) {
    ...
    private void deleteSelectedInstances() {
        if (mDeleteInstancesTask == null) {
            ...
            Toast.makeText(this, getString(R.string.file_delete_in_progress), Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void deleteComplete(int deletedInstances) {
        ...
        for (int i = 0; i < (mAdapter.getCount()); i++) {
            if (checked.get(i)) {
                removeFormArray.add(mAdapter.getItem(i)); // add form to be removed to the removeFormAray
            }
        }
